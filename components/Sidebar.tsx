...
import { LayoutDashboard, FilePlus, Search, Inbox, Building2, LogOut, Users, Files, Settings, X } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 py-6 space-y-1 overflow-y-auto">
          ...
          <NavLink to="/register" className={navClasses} onClick={() => window.innerWidth < 768 && close()}>
            <FilePlus size={18} />
            <span className="flex-1">Registrar</span>
          </NavLink>
          
          <NavLink to="/inbox" className={navClasses} onClick={() => window.innerWidth < 768 && close()}>
            <Inbox size={18} />
          ...
          <NavLink to="/documents" className={navClasses} onClick={() => window.innerWidth < 768 && close()}>
            <Files size={18} />
            <span className="flex-1">Archivo</span>
          </NavLink>
          
          <NavLink to="/search" className={navClasses} onClick={() => window.innerWidth < 768 && close()}>
            <Search size={18} />
